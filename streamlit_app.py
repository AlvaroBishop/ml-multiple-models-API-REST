...
# python -m streamlit run streamlit_app.py --server.enableXsrfProtection false # esto hace que si subes cualquier cosa a la aplicacion de streamlit no te de ningun error
